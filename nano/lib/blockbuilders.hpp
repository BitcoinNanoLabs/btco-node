...
public:
	...
	/** Set account from an xrb_ or btco_ address */
	...
	/** Set representative from an xrb_ or btco_ address */
	...
	/** Set link from an xrb_ or btco_ address */
...
public:
	...
	/** Set destination from an xrb_ or btco_ address */
