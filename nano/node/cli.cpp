...
std::error_code nano::handle_node_options (boost::program_options::variables_map const & vm)
{
	...
	else if (vm.count ("generate_config"))
	{
		...
		if (valid_type)
		{
			std::cout << "# This is an example configuration file for Nano. Visit https://docs.bitcoinnano.org/running-a-node/configuration/ for more information.\n#\n"
					  ...
					  << "# Additional information for notable configuration options is available in https://docs.bitcoinnano.org/running-a-node/configuration/#notable-configuration-options\n";
